...
description: Redis caching strategies and performance optimization techniques
---

import { Zap, Settings, Lock, Database, CheckCircle } from 'lucide-react';
...
<Callout title="Redis Caching Strategy" type="info">
  ACK NestJS Boilerplate uses Redis as a high-performance cache backend with cache-manager v6 and Keyv interface for singleton pattern, global module access, and session management.
</Callout>
...
<Cards>
    <Card type="link" href="configuration" icon={<Settings />}>
        Configuration Documentation - Redis configuration settings
    </Card>

    <Card type="link" href="environment" icon={<Lock />}>
        Environment Documentation - Redis environment variables
    </Card>

    <Card type="link" href="authentication" icon={<CheckCircle />}>
        Authentication Documentation - Session cache usage examples
    </Card>

    <Card type="link" href="response" icon={<Database />}>
        Response Documentation - Response caching implementation
    </Card>
</Cards>
...
<InlineTOC
    ...
    items={[
        ...
        },
        {
            ...
            url: '#principles--patterns',
            depth: 2,
        },
        {
            title: 'DRY & Singleton Pattern',
            url: '#dry--singleton-pattern',
            depth: 3,
        },
        {
            title: 'Global Module Pattern',
            url: '#global-module-pattern',
            depth: 3,
        },
        {
            title: 'Architecture',
        ...
        },
        {
            ...
            url: '#module-dependency-flow',
            depth: 3,
        },
        {
            title: 'RedisCacheModule',
            url: '#rediscachemodule',
            depth: 3,
        },
        {
            title: 'CacheMainModule',
            url: '#cachemainmodule',
            depth: 3,
        },
        {
        ...
        },
        {
            ...
            url: '#redis-configuration',
            depth: 3,
        },
        {
            title: 'Module Import Order',
            url: '#module-import-order',
            depth: 3,
        },
        {
            title: 'Usage',
        ...
        {
            title: 'Injecting Cache Providers',
            url: '#injecting-cache-providers',
            depth: 3,
        },
        {
