...
description: Comprehensive security measures, middleware configuration, and best practices
---

import { Shield, Lock, AlertCircle, CheckCircle, Settings } from 'lucide-react';
...
<Callout title="Multi-Layer Security Architecture" type="info">
  ACK NestJS Boilerplate implements comprehensive security through middleware, guards, decorators, rate limiting, CORS, HTTPS enforcement, and security headers to protect against common vulnerabilities.
</Callout>
...
<Cards>
    <Card type="link" href="authentication" icon={<Lock />}>
        Authentication Documentation - JWT, OAuth, and session management
    </Card>

    <Card type="link" href="authorization" icon={<Shield />}>
        Authorization Documentation - Role-based access control and policies
    </Card>

    <Card type="link" href="request-validation" icon={<CheckCircle />}>
        Request Validation Documentation - Input validation and sanitization
    </Card>
</Cards>
