...
description: Comprehensive activity logging, audit trails, and user action tracking
---
...
<Callout title="Future Plan" type="warning">
    Will support decorator-based logging for bidirectional activity and self
    activity.
</Callout>
