---
title: Authorization 
description: Role-based access control (RBAC) with CASL, policy management, and fine-grained permissions
---

import { Shield, Lock, Key, CheckCircle, AlertCircle, Settings } from 'lucide-react';
...
<Callout title="Layered Security Architecture" type="info">
  The authorization system implements multiple protection levels: user authentication, role-based access control (RBAC), policy-based permissions via CASL, and terms acceptance verification.
</Callout>
...
<Cards>
    <Card type="link" href="configuration" icon={<Settings />}>
        Configuration Documentation - For Redis configuration settings
    </Card>

    <Card type="link" href="environment" icon={<Lock />}>
    ...
    <Card type="link" href="activity-log" icon={<CheckCircle />}>
        Activity Log Documentation - For tracking authorization-related user activities
    </Card>

    <Card type="link" href="term-policy" icon={<Key />}>
        Term Policy Documentation - For managing user acceptance of terms and policies
    </Card>
</Cards>
...
<InlineTOC
    ...
    items={[
        ...
        {
            title: 'UserProtected() Decorator',
            url: '#userprotected-decorator',
            depth: 4,
        },
        {
            title: 'UserCurrent() Parameter Decorator',
            url: '#usercurrent-parameter-decorator',
            depth: 4,
        },
        {
            title: 'Guards',
        ...
        {
            title: 'RoleProtected() Decorator',
            url: '#roleprotected-decorator',
            depth: 4,
        },
        {
            title: 'Getting Current Role',
            url: '#getting-current-role',
            depth: 3,
        },
        {
            title: 'Guards',
        ...
        {
            title: 'Important Notes',
            url: '#important-notes-1',
            depth: 3,
        },
        {
            title: 'Policy Ability Protected',
            url: '#policy-ability-protected',
            depth: 2,
        },
        {
            title: 'Decorators',
        ...
        {
            title: 'PolicyAbilityProtected() Decorator',
            url: '#policyabilityprotected-decorator',
            depth: 4,
        },
        {
            title: 'Guards',
        ...
        {
            title: 'PolicyAbilityGuard',
            url: '#policyabilityguard',
            depth: 4,
        },
        {
            title: 'CASL Integration',
            url: '#casl-integration',
            depth: 3,
        },
        {
            title: 'Important Notes',
            url: '#important-notes-2',
            depth: 3,
        },
        {
            title: 'Term Policy Acceptance',
            url: '#term-policy-acceptance-protected',
            depth: 2,
        },
        {
            title: 'Decorators',
        ...
        {
            title: 'TermPolicyAcceptanceProtected() Decorator',
            url: '#termpolicyacceptanceprotected-decorator',
            depth: 4,
        },
        {
            title: 'Guards',
        ...
        {
            title: 'TermPolicyGuard',
            url: '#termpolicyguard',
            depth: 4,
        },
        {
            title: 'Important Notes',
            url: '#important-notes-3',
            depth: 3,
        },
        {
            title: 'Creating Custom Roles',
            url: '#creating-custom-roles',
            depth: 2,
        },
        {
            title: 'Overview',
        ...
        },
        {
            ...
            url: '#assigning-roles-to-users',
            depth: 3,
        },
        {
            title: 'Important Notes',
            url: '#important-notes-4',
            depth: 3,
        },
    ]}
/>
