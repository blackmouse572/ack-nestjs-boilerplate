...
description: Comprehensive guide on JWT, OAuth, social login, API keys, and session management
---
...
<Callout title="Comprehensive Authentication System" type="info">
    ACK NestJS Boilerplate provides a multi-layered authentication system
    supporting passwords, JWT tokens, social logins, API keys, and session
...
<Cards>
    <Card type="link" href="cache" icon={<Clock />}>
        Cache Documentation - Session storage and caching mechanisms
    </Card>

    <Card type="link" href="configuration" icon={<Shield />}>
        Configuration Documentation - Auth configuration details
    </Card>

    <Card type="link" href="environment" icon={<Key />}>
        Environment Documentation - JWT and OAuth environment variables
    </Card>
...
<InlineTOC
    ...
    items={[
        ...
        },
        {
            ...
            url: '#jwt-access-token-flow',
            depth: 4,
        },
        {
            title: 'JWT Refresh Token Flow',
            url: '#jwt-refresh-token-flow',
            depth: 4,
        },
        {
            title: 'JWT Tokens',
        ...
        {
            title: 'JWT Payload Structure',
            url: '#jwt-payload-structure',
            depth: 3,
        },
        {
            title: 'JWT Access Token Payload',
            url: '#jwt-access-token-payload',
            depth: 4,
        },
        {
            title: 'JWT Refresh Token Payload',
            url: '#jwt-refresh-token-payload',
            depth: 4,
        },
        {
            title: 'Usage',
        ...
        },
        {
            ...
            url: '#protecting-endpoints',
            depth: 4,
        },
        {
            title: 'Getting JWT Payload',
            url: '#getting-jwt-payload',
            depth: 4,
        },
        {
            title: 'Getting Raw Token',
            url: '#getting-raw-token',
            depth: 4,
        },
        {
            title: 'Security: JWT ID (jti)',
            url: '#security-jwt-id-jti',
            depth: 3,
        },
        {
            title: 'How it Works',
        ...
        {
            title: 'Social Authentication Flow',
            url: '#social-authentication-flow',
            depth: 3,
        },
        {
        ...
        {
            title: 'Setup Google OAuth 2.0',
            url: '#setup-google-oauth-20',
            depth: 4,
        },
        {
            title: 'Usage',
        ...
        },
        {
            ...
            url: '#two-factor-authentication-totp',
            depth: 2,
        },
        {
            title: 'Configuration',
        ...
        {
            title: 'Protecting Endpoints',
            url: '#protecting-endpoints-1',
            depth: 4,
        },
        {
            title: 'Getting API Key Payload',
            url: '#getting-api-key-payload',
            depth: 4,
        },
        {
            title: 'API Key Authentication Flow',
            url: '#api-key-authentication-flow',
            depth: 3,
        },
        {
        ...
        {
            title: 'Redis (Primary - Validation)',
            url: '#redis-primary---validation',
            depth: 4,
        },
        {
            title: 'Database (Secondary - Management)',
            url: '#database-secondary---management',
            depth: 4,
        },
        {
            title: 'How They Work Together',
            url: '#how-they-work-together',
            depth: 4,
        },
        {
        ...
        },
        {
            ...
            url: '#session-validation-flow',
            depth: 3,
        },
        {
            title: 'What Happens on Revocation',
            url: '#what-happens-on-revocation',
            depth: 3,
        },
    ]}
/>
...
All password settings are configured in `auth.config.ts`:

```typescript title="src/configs/auth.config.ts"
...
All JWT settings are configured in `auth.config.ts`:
...
|--------|--------------|---------------|
| **Algorithm** | ES256 (ECDSA using P-256 and SHA-256) | ES512 (ECDSA using P-521 and SHA-512) |
| **Validity** | Configured in `auth.config.ts` (default: 1 hour) | Configured in `auth.config.ts` (default: 30 days) |
| **Environment Variable** | `AUTH_JWT_ACCESS_TOKEN_EXPIRED` | `AUTH_JWT_REFRESH_TOKEN_EXPIRED` |
| **Purpose** | Authenticate API requests | Generate new access tokens without re-authentication |
| **jti** | Included for session tracking and validation | Included for session tracking and validation |
...
<TypeTable
  type={{
    ...
    loginFrom: {
      description: 'Source location of login',
      type: 'EnumUserLoginFrom',
    },
    loginWith: {
      description: 'Authentication method used',
      type: 'EnumUserSignUpWith',
    },
    email: {
...
<TypeTable
  type={{
    ...
    jti: {
      description: 'JWT ID for token validation',
      type: 'string',
    },
    expiredAt: {
