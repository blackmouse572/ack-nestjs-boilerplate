...
description: TOTP-based 2FA implementation with authenticator apps and backup codes
---

import { Key, CheckCircle, AlertCircle, Shield, Lock } from 'lucide-react';
...
<Callout title="Enhanced Account Security" type="info">
  ACK NestJS Boilerplate implements TOTP-based two-factor authentication with authenticator apps and backup codes for enhanced user account security.
</Callout>
