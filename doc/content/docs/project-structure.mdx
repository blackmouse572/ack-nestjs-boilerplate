...
description: Detailed overview of the modular architecture, folder organization, and design patterns
---

import { FolderTree, Database, Settings, CheckCircle, AlertCircle, BookOpen, Package } from 'lucide-react';
...
<Callout title="Modular Architecture" type="info">
  ACK NestJS Boilerplate follows a scalable, modular architecture with clear separation of concerns, organized into feature modules, shared modules, and configuration layers for maintainability and extensibility.
</Callout>
...
<Cards>
    <Card type="link" href="/docs/database" icon={<Database />}>
        Database Documentation - Database setup and Prisma configuration
    </Card>

    <Card type="link" href="/docs/configuration" icon={<Settings />}>
        Configuration Documentation - Config file structure and management
    </Card>

    <Card type="link" href="/docs/environment" icon={<Package />}>
        Environment Documentation - Environment variables reference
    </Card>
</Cards>
...
<InlineTOC
    ...
    items={[
        ...
        {
            title: 'DTOs',
            url: '#dtos-data-transfer-objects',
            depth: 3,
        },
        {
            title: 'Enums',
