...
description: Prisma setup, migrations, seeding, and multi-database support
---

import { Database, Settings, GitBranch, CheckCircle, AlertCircle } from 'lucide-react';
...
<Callout title="Database Architecture" type="info">
  ACK NestJS Boilerplate uses Prisma ORM with MongoDB, supporting replica sets, transactions, seeding, and multiple database connections with zero-migration approach.
</Callout>
...
<Cards>
    <Card type="link" href="installation" icon={<GitBranch />}>
        Installation Documentation - Complete project setup and dependencies
    </Card>

    <Card type="link" href="environment" icon={<Settings />}>
        Environment Documentation - Database connection and environment variables
    </Card>

    <Card type="link" href="configuration" icon={<CheckCircle />}>
        Configuration Documentation - Config module structure
    </Card>
</Cards>
...
<InlineTOC
    ...
    items={[
        ...
        {
            title: 'Template Seeds',
            url: '#template-seeds',
            depth: 3,
        },
        {
            title: 'Initial Seeded Data',
            url: '#initial-seeded-data',
            depth: 2,
        },
        {
            title: 'Docker',
