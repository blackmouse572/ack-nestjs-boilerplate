...
description: External service integrations including AWS S3, SES, Sentry, and OAuth providers
---

import { Plug, Lock, AlertCircle, CheckCircle, Settings } from 'lucide-react';
import { InlineTOC } from 'fumadocs-ui/components/inline-toc';

# Third Party Integration Documentation

<Callout title="Enterprise Integrations" type="info">
  ACK NestJS Boilerplate provides seamless integration with AWS services (S3, SES), error monitoring via Sentry, OAuth providers (Google, Apple), and other third-party services with production-ready configuration.
</Callout>
