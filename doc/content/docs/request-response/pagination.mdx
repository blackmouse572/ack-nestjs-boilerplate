---
title: Pagination
description: Comprehensive pagination system with cursor-based and offset-based pagination support
---

import { List, Database, FileText, CheckCircle, AlertCircle } from 'lucide-react';
...
<Callout title="Advanced Pagination System" type="info">
  ACK NestJS Boilerplate provides both cursor-based and offset-based pagination strategies with decorators, DTOs, and utilities for efficient data retrieval and filtering.
</Callout>
