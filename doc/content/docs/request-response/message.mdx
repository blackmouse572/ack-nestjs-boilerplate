...
description: Multi-language support, message formatting, and internationalization (i18n) setup
---

import { Globe, FileText, CheckCircle, AlertCircle } from 'lucide-react';
...
<Callout title="Multi-Language Support" type="info">
  ACK NestJS Boilerplate provides comprehensive internationalization (i18n) with support for multiple languages, message formatting, currency localization, and error message translation for global applications.
</Callout>
