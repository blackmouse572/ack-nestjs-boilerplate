...
description: Standardized API response formatting, serialization, and transformation
---

import { Send, Cache, FileText, CheckCircle, Lock } from 'lucide-react';
...
<Callout title="Standardized Response Format" type="info">
  ACK NestJS Boilerplate uses decorators to automatically format responses with consistent structures, pagination support, file downloads, custom headers, and localized messages through interceptors.
</Callout>
...
<Cards>
    <Card type="link" href="message" icon={<FileText />}>
        Message Documentation - Internationalization and error message translation
    </Card>

    <Card type="link" href="handling-error" icon={<CheckCircle />}>
        Handling Error Documentation - Exception handling and response formatting
    </Card>

    <Card type="link" href="doc" icon={<Lock />}>
        Doc Documentation - API documentation integration with DTOs
    </Card>

    <Card type="link" href="file-upload" icon={<Send />}>
        File Upload Documentation - File validation pipes
    </Card>
</Cards>
...
<InlineTOC
    ...
    items={[
        ...
        },
        {
            ...
            url: '#activity-log-metadata-optional',
            depth: 3,
        },
        {
            title: 'Caching',
