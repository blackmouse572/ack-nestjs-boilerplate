...
description: Comprehensive request validation, sanitization, and custom decorators
---

import { CheckCircle, AlertCircle, Shield, FileText } from 'lucide-react';
...
<Callout title="Input Validation Framework" type="info">
  ACK NestJS Boilerplate uses class-validator decorators with NestJS ValidationPipe to validate request body, query parameters, and path parameters with comprehensive error handling and custom validators.
</Callout>
...
<Cards>
    <Card type="link" href="handling-error" icon={<AlertCircle />}>
        Error Handling Documentation - Exception handling and response formatting
    </Card>

    <Card type="link" href="message" icon={<FileText />}>
        Message Documentation - Error message internationalization
    </Card>

    <Card type="link" href="doc" icon={<CheckCircle />}>
        API Documentation - DTOs and documentation integration
    </Card>
</Cards>
...
<InlineTOC
    ...
    items={[
        ...
        },
        {
            ...
            url: '#request-body-validation',
            depth: 3,
        },
        {
            title: 'Query Parameters Validation',
            url: '#query-parameters-validation',
            depth: 3,
        },
        {
        ...
        },
        {
            ...
            url: '#intersectiontype',
            depth: 3,
        },
        {
            title: 'Custom Validators',
            url: '#custom-validators',
            depth: 2,
        },
        {
            title: 'Available Custom Validators',
            url: '#available-custom-validators',
            depth: 3,
        },
        {
            title: 'Creating Custom Validator',
            url: '#creating-custom-validator',
            depth: 3,
        },
        {
            title: 'Validation Pipes',
            url: '#validation-pipes',
            depth: 2,
        },
        {
            title: 'Error Message Mapping',
            url: '#error-message-mapping',
            depth: 2,
        },
    ]}
/>
