...
description: User terms acceptance, policy management, and compliance tracking
---

import { FileCheck, Lock, CheckCircle, AlertCircle, Settings } from 'lucide-react';
...
<Callout title="Terms & Policy Management" type="info">
  ACK NestJS Boilerplate provides a comprehensive system for managing user acceptance of terms and policies with versioning, audit trails, and compliance tracking.
</Callout>
...
<Mermaid chart="flowchart TD
    ...
    CheckAcceptance -->|No| ErrorRequired[Throw 403: Forbidden<br/>REQUIRED_INVALID]
