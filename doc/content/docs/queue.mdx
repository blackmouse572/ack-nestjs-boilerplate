...
description: BullMQ integration for asynchronous job processing and task scheduling
---

import { Clock, Settings, CheckCircle, AlertCircle, FileText } from 'lucide-react';
...
<Callout title="Background Job Processing" type="info">
  ACK NestJS Boilerplate uses BullMQ for reliable asynchronous job processing with Redis, featuring job queues, retries, delayed execution, and comprehensive monitoring.
</Callout>
