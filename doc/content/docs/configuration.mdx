...
description: Environment variables, app configuration, and dynamic settings management
---

import { Settings, Lock, Database, Cloud, LogIcon, FileText, Key, Users, Book, MessageSquare, Mail, CheckCircle, RotateCcw, Home, Clock, FileJson, Flag, Send } from 'lucide-react';
...
<Cards>
    ...
    <Card type="link" href="cache" icon={<Key />}>
...
<InlineTOC
    ...
    items={[
        ...
        },
        {
            ...
            url: '#aws-configuration',
            depth: 2,
        },
        {
            title: 'Logger Configuration',
            url: '#logger-configuration',
            depth: 2,
        },
        {
        ...
        {
            title: 'Forgot Password Configuration',
            url: '#forgot-password-configuration',
            depth: 2,
        },
        {
        ...
        {
            title: 'Term Policy Configuration',
            url: '#term-policy-configuration',
            depth: 2,
        },
        {
            title: 'Feature Flag Configuration',
            url: '#feature-flag-configuration',
            depth: 2,
        },
        {
